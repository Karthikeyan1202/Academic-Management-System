...
class Student extends CI_Controller { 
    ...
    function manage_profile($param1 = null, $param2 = null, $param3 = null){
        ...
        $select_student_class_id = $student_profile->class_id; 
            ...
            $return_student_id = $this->db->get_where('student', array('class_id' => $select_student_class_id, 'student_id !=' => $this->session->userdata('student_id')))->result_array();
     
            $page_data['page_name']     = 'class_mate';
            $page_data['page_title']    = get_phrase('Classmates');
            $page_data['select_student'] = $return_student_id;
            $this->load->view('backend/index', $page_data);
        }
