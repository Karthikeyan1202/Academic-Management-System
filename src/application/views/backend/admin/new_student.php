	...
	<a href="<?php echo base_url();?>admin/section/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
			...
			<div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
							<input type="date" value="2023-04-19" id="example-date-input" class="form-control datepicker" name="date_of_leaving">
                    ...
                    <div class="col-sm-12">
							<input type="date" value="2023-04-19" id="example-date-input" class="form-control datepicker" name="am_date">
