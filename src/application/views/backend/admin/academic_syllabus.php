...
<!----CREATION FORM STARTS---->
			...
			<!----CREATION FORM ENDS-->
                    ...
                    <a href="<?php echo base_url();?>admin/download_academic_syllabus/<?php echo $syllabus['file_name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></button></a>
