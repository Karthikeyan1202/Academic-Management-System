				...
				<div class="panel-body table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo date( $row['creation_timestamp']);?></td>
							<td>
								<?php if ($row ['status']=='2'):?>                    	
								<!-- <a href="<?php echo base_url();?>student/payment_invoice/<?php echo $row['invoice_id'].'?'.sha1($row['title']).'?='.$row['description'];?>" 
								class="btn btn-info btn-rounded btn-sm"  style="color:white"><i class="fa fa-credit-card"></i>&nbsp;Pay Invoice 
								</a> -->
								<?php endif;?>
        					</td>
                        </tr>
